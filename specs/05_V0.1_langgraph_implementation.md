...
> **Status:** Historical migration specification. Retained for design history;
...
completed on 2026-08-18. On 2026-08-19, a live `gpt-5.4-mini` parity solve
...
patching global APIs or making live calls.
...
Normal tests must not require Docker, network access, an OpenAI key, or a live
