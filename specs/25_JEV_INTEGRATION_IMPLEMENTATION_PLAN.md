...
> `sage/harness/context/`, and repository indexing/retrieval in
> `sage/harness/retrieval/`. A–E modes,
...
> Future experiments compare graph-only retrieval and unchanged Jev policies;
