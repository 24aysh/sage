"""Native read-only agent adapters for a validated Repository retrieval index snapshot."""

from __future__ import annotations

from sage.harness.retrieval.context import minimal_result as _minimal_result, bounded_json as _bounded_json
...
DEFAULT_RETRIEVAL_TOOL_OUTPUT_CHARS = 12_000
...
def build_retrieval_tools(
    ...
    *,
    repo_root: Path,
    index_file: Path,
    output_chars: int = DEFAULT_RETRIEVAL_TOOL_OUTPUT_CHARS,
    ...
    if output_chars < 1_000:
        raise ValueError("Repository retrieval index tool output_chars must be at least 1000.")
